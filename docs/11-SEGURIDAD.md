...
| `LeaderboardSanity` | Bloquea upload si tiempo absurdo / replay mismatch | No verifica scores ajenos en servidor |
...
Antes de `UploadRecord`: tiempo bounds, replay existe, `DataChecksum` OK, `|duration − score| < 0.05s`, level hash match, oficial intacto.
